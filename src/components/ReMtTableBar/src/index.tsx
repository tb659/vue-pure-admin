...
import { defineComponent, ref, computed, type PropType, nextTick, unref, getCurrentInstance, Fragment } from "vue";
...
export default defineComponent({
  ...
  setup(props, { emit, slots, attrs }) {
    ...
    function onExpand() {
      ...
      toggleRowExpansionAll(props.tableRef.value.data, isExpandAll.value);
    }
    ...
    function toggleRowExpansionAll(data, isExpansion) {
      data.forEach(item => {
        props.tableRef.value.toggleRowExpansion(item, isExpansion);
    ...
    const reference = {
      reference: () => (
        <SettingIcon class={["w-[16px]", iconClass.value]} onMouseover={e => (buttonRef.value = e.currentTarget)} />
      ),
    };
                        ...
                        {checkColumnList.map(item => {
                          return (
                            <div class="flex items-center">
                              ...
                              />
                              <el-checkbox key={item} value={item} onChange={value => handleCheckColumnListChange(value, item)}>
