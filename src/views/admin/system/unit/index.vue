...
const { title, visible, loading, tableState, operationList, tableRegister, handleAdd, handleDel, handleSubmit, setSearchParams } =
  useHook();
</script>
...
<template>
  <div class="main">
    ...
    <MtTableBar title="机构列表" :columns="tableColumns" @refresh="setSearchParams">
      <template #buttons>
