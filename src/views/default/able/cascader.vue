    ...
    <el-row :gutter="20">
      <el-col :xl="12" :lg="12" :md="24" :sm="24" :xs="24">
        <div class="flex flex-col items-center justify-center">
          <span class="imp">
            1. 二级联动（不带“全部”选项）
            <el-cascader v-model="selectedOptions1" :options="provinceAndCityData" @change="handleChange" />
          </span>
      ...
      <el-col :xl="12" :lg="12" :md="24" :sm="24" :xs="24">
        <div class="flex flex-col items-center justify-center mt-3">
          <span class="imp">
            2. 二级联动（带有“全部”选项）
            <el-cascader v-model="selectedOptions3" :options="provinceAndCityDataPlus" @change="handleChange" />
          </span>
          <div class="leading-10">
      ...
      <el-col :xl="12" :lg="12" :md="24" :sm="24" :xs="24">
        <div class="flex flex-col items-center justify-center mt-3">
          <span class="imp">
            4. 三级联动（带"全部选项"）
            <el-cascader v-model="selectedOptions4" :options="regionDataPlus" @change="handleChange" />
          </span>
          <div class="leading-10">
