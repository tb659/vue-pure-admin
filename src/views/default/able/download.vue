...
import { downloadByOnlineUrl, downloadByBase64, downloadByData, downloadByUrl } from "@pureadmin/utils";
...
<template>
  <el-card shadow="never">
    ...
    <div class="flex flex-wrap">
      <el-button @click="downloadByOnlineUrl('https://xiaoxian521.github.io/hyperlink/img/pure.png', 'test-url.png')">
        下载在线图片
      </el-button>
      ...
      <el-button
        @click="downloadByUrl('https://github.com/xiaoxian521/xiaoxian521/archive/refs/heads/main.zip', 'xiaoxian521.zip')"
      >
        根据文件地址下载文件
      </el-button>
