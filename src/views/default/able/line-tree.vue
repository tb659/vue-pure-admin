    ...
    <el-row :gutter="24">
      <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12" class="mb-[20px]">
        <el-card shadow="never">
          ...
          <div class="max-h-[550px] overflow-y-auto">
            <el-tree :data="menusData" :props="dataProps" show-checkbox default-expand-all node-key="uniqueId" :indent="30"
      ...
      <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
        <el-card shadow="never">
          ...
          <div class="max-h-[550px] overflow-y-auto">
            <el-tree-v2 :data="menusData" :props="dataProps" show-checkbox :height="550" :default-expanded-keys="expandedKeys">
              <template #default="{ node }">
                <el-tree-line :node="node" :tree-data="menusData" :show-label-line="true" :indent="30">
                  <template #node-label>
                    <span class="text-sm">
                      {{ transformI18n(node.data.meta.title) }}
                    </span>
