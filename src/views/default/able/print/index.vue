...
<template>
  <el-card shadow="never">
    <template #header>
      ...
      <el-link class="mt-2" href="https://github.com/pure-admin/vue-pure-admin/blob/main/src/views/able/print" target="_blank">
    ...
    <el-row :gutter="24">
      ...
      >
        ...
        <el-table border :data="tableData" :row-class-name="tableRowClassName" class="el-table w-full mt-[10px]">
      ...
      >
        ...
        <img src="https://pure-admin-utils.netlify.app/logo.png" alt="avatars" class="img mt-[10px] m-auto" />
      </el-col>
    </el-row>
  </el-card>
</template>
