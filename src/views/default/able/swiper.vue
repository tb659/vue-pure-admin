  ...
  <el-card shadow="never">
    <template #header>
      <div class="font-medium">
        Swiper插件（
        <el-link href="https://github.com/nolimits4web/swiper" target="_blank" style="margin: 0 5px 4px 0; font-size: 16px">
          github地址
        </el-link>
        ）
      </div>
      ...
      <el-col v-for="item in swiperExample" :key="item.id" :span="12">
        ...
        <swiper v-bind="item.options">
          <swiper-slide v-for="i in 5" :key="i">
            <div class="flex justify-center items-center h-[240px] border-[1px] border-[#999] text-[18px] font-bold">
              Slide{{ i }}
            </div>
          </swiper-slide>
        </swiper>
