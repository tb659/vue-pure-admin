...
<template>
  <el-card shadow="never">
    <template #header>
      <div class="card-header">
        <span class="font-medium">
          <p>
            基于自定义编译
            <el-link href="https://github.com/FFmpeg/FFmpeg" target="_blank" style="margin: 0 4px 5px; font-size: 16px">
              FFmpeg
            </el-link>
          ...
          <el-link href="https://github.com/wanwu/cheetah-capture" target="_blank" style="margin: 0 4px 5px; font-size: 16px">
            cheetah-capture
          </el-link>
          和
          <el-link href="https://github.com/jordiwang/web-capture" target="_blank" style="margin: 0 4px 5px; font-size: 16px">
            web-capture
          </el-link>
          修改并编译wasm等文件（强烈推荐在Ubuntu系统进行编译）
          <p>
            mac系统推荐安装
            <el-link href="https://github.com/utmapp/UTM" target="_blank" style="margin: 0 4px 5px; font-size: 16px">
              UTM
            </el-link>
          ...
          <p>
            ...
            <el-link href="https://ffmpegwasm.netlify.app/" target="_blank" style="margin: 0 4px 5px; font-size: 16px">
              ffmpeg.wasm
            </el-link>
    ...
    <div class="flex flex-wrap">
      <el-upload drag :show-file-list="false" accept=".mp4,.mov,.avi,.webm,.mkv" :before-upload="beforeUpload">
        <div class="el-upload__text">可拖拽上传视频（默认截取16张帧图片，可在代码中自行修改）</div>
      </el-upload>
      <el-image v-if="curImg" :src="curImg" :preview-src-list="Array.of(curImg)" class="w-[180px] h-[180px] ml-2 rounded-[6px]" />
    </div>
    <div
      id="canvas-container"
      v-loading="loading"
