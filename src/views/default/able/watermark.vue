  ...
  <el-card shadow="never">
    <template #header>
      <div class="card-header">
        <span class="font-medium"> 页面水印功能（将平台主题改为亮白色观察水印效果更明显哦） </span>
      </div>
    </template>
    <span> 请输入要创建水印的值：</span>
    <el-input v-model="value" class="mb-4 mr-4" style="width: 200px" clearable />
    <span>请选择要创建水印的颜色：</span>
    <el-color-picker v-model="color" show-alpha />
    <br />
    <el-button @click="setWatermark(value, { fillStyle: color })"> 创建整页水印 </el-button>
    <el-button
      @click="
        setWatermark(value, {
          gradient: [
    ...
    <div ref="local" class="mt-4 mb-4 w-[1080px] h-[400px] border-dotted border-2 border-sky-500" />
    <el-button
      @click="
    ...
    <div ref="preventLocal" class="mt-4 mb-4 w-[1080px] h-[400px] border-dotted border-2 border-indigo-500" />
  </el-card>
</template>
