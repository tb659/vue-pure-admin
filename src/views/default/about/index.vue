  ...
  <div>
    ...
    <el-card class="m-4 box-card" shadow="never">
      ...
      <el-descriptions border>
        <el-descriptions-item v-for="(item, index) in schema" :key="index" :label="item.label" label-align="left" align="left">
    ...
    <el-card class="m-4 box-card" shadow="never">
      ...
      <el-descriptions border>
        <el-descriptions-item v-for="(item, index) in devSchema" :key="index" :label="item.label" label-align="left" align="left">
          <a :href="'https://www.npmjs.com/package/' + item.label" target="_blank">
            <span style="color: var(--el-color-primary)">{{ item.field }}</span>
          </a>
        </el-descriptions-item>
