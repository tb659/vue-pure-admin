...
<template>
  <el-card shadow="never">
    ...
    <PlusCheckCardGroup v-model="list" :options="options" :size="dynamicSize" :disabled="size === 'disabled'" />

    <div class="mb-2 mt-4">多选</div>
    <PlusCheckCardGroup v-model="list1" :options="options" :size="dynamicSize" :disabled="size === 'disabled'" multiple />
  </el-card>
</template>
