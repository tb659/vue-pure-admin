...
function onBeforeSureClick() {
  addDialog({
    title: "点击底部确定按钮的回调",
    contentRenderer: () => <p>弹框内容-点击底部确定按钮的回调（会暂停弹框的关闭，经常用于新增、修改弹框内容后调用接口）</p>,
...
<template>
  <el-card shadow="never">
    <template #header>
      ...
      <el-link href="https://github.com/pure-admin/vue-pure-admin/tree/main/src/views/components/dialog" target="_blank">
