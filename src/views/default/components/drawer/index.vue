...
function onBeforeSureClick() {
  addDrawer({
    title: "点击底部确定按钮的回调",
    contentRenderer: () => <p>抽屉内容-点击底部确定按钮的回调（会暂停抽屉的关闭，经常用于新增、修改抽屉内容后调用接口）</p>,
...
<template>
  <el-card shadow="never">
    <template #header>
      ...
      <el-link href="https://github.com/pure-admin/vue-pure-admin/tree/main/src/views/components/drawer" target="_blank">
    ...
    <el-divider />
    <el-space wrap>
      <el-button @click="onBeforeCancelClick"> 点击底部取消按钮的回调（会暂停抽屉的关闭） </el-button>
