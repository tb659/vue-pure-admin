...
<template>
  <el-card shadow="never">
    ...
    <el-button text bg type="primary" :size="dynamicSize" :disabled="size === 'disabled'" :loading="size !== 'disabled'">
    ...
    <el-button type="primary" :size="dynamicSize" :disabled="size === 'disabled'" :loading="size !== 'disabled'">
      <template #loading>
    ...
    <el-button tag="div" role="button" tabindex="0" :size="dynamicSize" :disabled="size === 'disabled'"> div 标签 </el-button>
    <el-button
      type="primary"
      tag="a"
    ...
    <el-space wrap>
      <el-button color="#626aef" :size="dynamicSize" :disabled="size === 'disabled'" :dark="isDark"> Default </el-button>
      <el-button color="#626aef" :size="dynamicSize" :disabled="size === 'disabled'" :dark="isDark" plain> Plain </el-button>
    </el-space>
  </el-card>
</template>
