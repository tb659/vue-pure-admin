...
<template>
  <div class="main">
    ...
    <mt-table-bar title="角色列表（仅演示，操作后不生效）" :columns="columns" @refresh="onSearch">
      <template #buttons>
      ...
      <template #default="{ size, dynamicColumns }">
        ...
        >
          <template #operation="{ row }">
            ...
            <el-button class="reset-margin" link type="primary" :size="size" :icon="useRenderIcon(Menu)" @click="handleMenu">
              菜单权限
            </el-button>
