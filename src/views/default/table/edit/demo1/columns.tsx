...
export function useColumns() {
  ...
  const columns: TableColumnList = [
    ...
    },
    {
      ...
      prop: "sex",
      cellRenderer: ({ row }) => (
        <el-switch v-model={row.sex} inline-prompt active-value={0} inactive-value={1} active-text="男" inactive-text="女" />
      ),
    },
    {
      label: "爱好",
    ...
    },
    {
      ...
      prop: "date",
      cellRenderer: ({ row }) => (
        <el-date-picker v-model={row.date} type="date" format="YYYY/MM/DD" value-format="YYYY-MM-DD" placeholder="请选择日期" />
      ),
      minWidth: 110,
    },
    {
