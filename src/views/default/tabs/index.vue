...
<template>
  <el-card shadow="never">
    <template #header>
      ...
      <el-link class="mt-2" href="https://github.com/pure-admin/vue-pure-admin/blob/main/src/views/tabs" target="_blank">
        代码位置 src/views/tabs
      </el-link>
    </template>
    <div class="flex flex-wrap items-center">
      <p>query传参模式：</p>
      <el-button v-for="index in 6" :key="index" class="m-2!" @click="toDetail({ id: index }, 'query')">
        打开{{ index }}详情页
      </el-button>
    ...
    <div class="flex flex-wrap items-center">
      <p>params传参模式：</p>
      <el-button v-for="index in 6" :key="index" class="m-2!" @click="toDetail({ id: index }, 'params')">
        打开{{ index }}详情页
      </el-button>
    </div>
    ...
    <el-button @click="router.push({ path: '/nested/menu1/menu1-2/menu1-2-2' })"> 跳转页内菜单（传path对象） </el-button>
