...
<template>
  ...
  <svg v-else-if="name === 'stop'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" height="24">
    <path
      fill="currentColor"
  ...
  <svg v-else-if="name === 'horizontal'" viewBox="0 0 24 24" height="24" xmlns="http://www.w3.org/2000/svg">
  ...
  <svg v-else-if="name === 'vertical'" viewBox="0 0 24 24" height="24" xmlns="http://www.w3.org/2000/svg">
  ...
  <svg v-else-if="name === 'shuffle'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" height="24">
    <path
      fill="currentColor"
