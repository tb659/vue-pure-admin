...
declare global {
  ...
  export interface AutocompleteComponentProps extends Partial<AutocompleteProps> {
    ...
    slots?: {
      default?: (...args: any[]) => string | JSX.Element | null;
      prefix?: (...args: any[]) => string | JSX.Element | null;
      suffix?: (...args: any[]) => string | JSX.Element | null;
      prepend?: (...args: any[]) => string | JSX.Element | null;
      append?: (...args: any[]) => string | JSX.Element | null;
    };
    style?: CSSProperties;
  }
  ...
  export interface SelectComponentProps extends Omit<Partial<ISelectProps>, "options"> {
    ...
    slots?: {
      default?: (options: SelectOption[]) => string | JSX.Element[] | null;
      optionGroupDefault?: (item: SelectOption) => string | JSX.Element;
      optionDefault?: (option: SelectOption) => string | JSX.Element | null;
      prefix?: (...args: any[]) => string | JSX.Element | null;
      empty?: (...args: any[]) => string | JSX.Element | null;
    };
    options?: SelectOption[];
    style?: CSSProperties;
  }
  ...
  export interface SelectV2ComponentProps {
    ...
    options?: SelectOption[];
    slots?: {
      default?: (option: SelectOption) => string | JSX.Element | null;
    };
    style?: CSSProperties;
  }
  ...
  export interface TransferComponentProps extends Partial<TransferProps> {
    ...
    slots?: {
      default?: (...args: any[]) => string | JSX.Element | null;
      leftFooter?: (...args: any[]) => string | JSX.Element | null;
      rightFooter?: (...args: any[]) => string | JSX.Element | null;
    };
    style?: CSSProperties;
  }
  ...
  export interface DatePickerComponentProps extends Partial<DatePickerProps> {
    ...
    slots?: {
      default?: (...args: any[]) => string | JSX.Element | null;
      rangeSeparator?: (...args: any[]) => string | JSX.Element | null;
    };
    style?: CSSProperties;
  }
  ...
  export interface FormItemProps extends Partial<ElFormItemProps> {
    ...
    slots?: {
      default?: (...args: any[]) => string | JSX.Element | null;
      label?: (...args: any[]) => string | JSX.Element | null;
      error?: (...args: any[]) => string | JSX.Element | null;
    };
  }
  ...
  export interface UploadComponentProps extends Partial<UploadProps> {
    slots?: {
      default?: (...args: any[]) => string | JSX.Element | null;
      trigger?: (...args: any[]) => string | JSX.Element | null;
      tip?: (...args: any[]) => string | JSX.Element | null;
      file?: (...args: any[]) => string | JSX.Element | null;
    };
    style?: CSSProperties;
  }
  ...
  export interface FormSchema {
    ...
    remove?: boolean;
    /** 是否隐藏 必须是个函数 ({ schema, model }) => boolean */
