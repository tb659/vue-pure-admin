...
declare global {
  ...
  interface TableColumn extends ElTableColumn {
    ...
    /** 表格最后一行自定义索引 */
    index?: (index: number, tableDataLength: number, indexValue: number) => number | string;
    /** 自定义插槽 */
    slot?: string;
    /** 首次加载是否隐藏 */
    initHidden?: boolean;
    ...
    /** 自定义单元格渲染器 */
    cellRenderer?: (data: TableColumnRenderer) => string | VNode;
    /** 自定义头部渲染器 */
    headerRenderer?: (data: TableColumnRenderer) => string | VNode;
  }
  /**
   ...
   * @see {@link https://element-plus.org/zh-CN/component/table.html#table-%E5%B1%9E%E6%80%A7}
   */
  interface MtTableProps extends TableProps {
    pageSize?: number;
    pageNumber?: number;
